...
{
    class OpwElectionProvider : ProviderBase, IElectionProvider
    {
        const string URI_CANDIDATES = "http://dev.otwartapw.pl/opw/service/komisja/{0}";
        const string URI_COMMISSION = "http://dev.otwartapw.pl/opw/service/komisja/{0}";
        const string URI_UPLOAD = "http://dev.otwartapw.pl/opw/service/komisja/{0}/protokol";
        ...
        public class CommissionResponseData
        {
            ...
            [DataMember(Name = "okregowa")]
            public DistrictDto District { get; set; }

            [DataMember(Name = "kandydatList")]
