...
{
    class DevStorageProvider : ProviderBase, IStorageProvider
    {
        const string URI_PREPARE = "http://169.254.80.80:8733/Design_Time_Addresses/image/prepare";
